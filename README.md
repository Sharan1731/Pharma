...
<head>
  ...
  <title>Home - SHARAN Pharma</title>
  <!-- Bootstrap CSS -->
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <a class="navbar-brand" href="#">SHARAN Pharma</a>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-8">
        <h2>WELCOME TO SHARAN PHARMA</h2>
      ...
      <div class="col-md-4">
        <img src="loga pharma.jpeg" class="img-fluid" alt="Pharmacy Image">
      </div>
    </div>
  </div>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 SHARAN Pharma. All rights reserved. BY SHARAN C</p>
  </footer>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>About SHARAN Pharma</title>
  <!-- Bootstrap CSS -->
  <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
  ...
  <body background="download (2).jpeg" style="background-repeat: no-repeat; background-size: cover;"></body>
  <!-- Footer -->
  <footer class="bg-dark text-white text-center py-4 mt-3">
    <p>&copy; 2024 SHARAN Pharma. All rights reserved.  BY SHARAN G</p>
  </footer>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Products - SHARAN Pharma</title>
  <!-- Bootstrap CSS -->
  <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          ...
          <div class="card">
            <img src="DRUG.jpeg" class="card-img-top" alt="Product 2" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="SUPILMENT.jpeg" class="card-img-top" alt="Product 3" width="200" height="200">
            <div class="card-body">
  ...
  <body background="download (3).jpeg" style="background-repeat: no-repeat; background-size: cover;">
...
## OUTPUT:
![alt text](<Screenshot 2024-05-13 224111.png>)
![alt text](<Screenshot 2024-05-13 224543.png>)
![alt text](<Screenshot 2024-05-13 224820.png>)
![alt text](<Screenshot 2024-05-13 225147.png>)
